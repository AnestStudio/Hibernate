...
Trong Hibernate, một thực thể có thể bị xóa khỏi cơ sở dữ liệu bằng cách gọi `Session.delete()` hoặc `Session.remove()`. Sử dụng các phương thức này, chúng ta có thể xóa một đối tượng __transient__ hoặc __persistent__ khỏi kho dữ liệu.
