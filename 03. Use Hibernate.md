...
- `Session.update()`: phương thức này thuộc original Hibernate, không còn được sử dụng nữa từ version 6.0.
...
- `Session.delete()`: phương thức này thuộc original Hibernate, không còn được sử dụng nữa từ version 6.0.
