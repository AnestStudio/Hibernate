...
| Kết quả	  | Luôn trả về một đối tượng, có thể là null |	Có thể trả về null nếu không tìm thấy đối tượng |
| Lấy dữ liệu |	Lấy dữ liệu từ bộ nhớ đệm (cache) nếu có, hoặc truy vấn cơ sở dữ liệu nếu không | Luôn truy vấn cơ sở dữ liệu |
