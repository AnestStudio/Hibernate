...
Đầu tiên chúng ta cần tạo một thuộc tính đại diện cho liên kết là `private User user` và liên kết one-to-one phải được chú thích bằng annotation `@OneToOne`.
